...
between :white_circle:srcip=:white_circle: and :white_circle: :white_circle: (space) \
:arrow_right: `awk -F':white_circle:srcip=:white_circle:' '{print $2}' | awk -F':white_circle: :white_circle:' '{print $1}')`\
or\

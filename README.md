...
Flexibility | Can develop search criteria what even you think, e.g. 
- any source IP to a destinated IP access more than 20 different ports | Limit to the product capability
